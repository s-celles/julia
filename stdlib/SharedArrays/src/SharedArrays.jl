...
import Base: length, size, ndims, IndexStyle, reshape, convert, deepcopy_internal, serialize, deserialize,
             show, getindex, setindex!, fill!, rand!, similar, reduce, map!, memcopy!, unsafe_convert
import Base.Random
...
memcopy!(S::SharedArray, A::Array) = (memcopy!(S.s, A); S)

function memcopy!(S::SharedArray, R::SharedArray)
