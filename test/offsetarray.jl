...
fill!(a, -1)
memcopy!(a, (1,2))   # non-array iterables
@test a[-3] == 1
@test a[-2] == 2
@test a[-1] == -1
fill!(a, -1)
...
@test a[-2] == 1
@test a[-1] == 2
@test_throws BoundsError memcopy!(a, 1, (1,2))
fill!(a, -1)
memcopy!(a, -2, (1,2,3), 2)
@test a[-3] == -1
@test a[-2] == 2
@test a[-1] == 3
@test_throws BoundsError memcopy!(a, -2, (1,2,3), 1)
fill!(a, -1)
memcopy!(a, -2, (1,2,3), 1, 2)
@test a[-3] == -1
@test a[-2] == 1
@test a[-1] == 2
...
@test a[-2] == 1
@test a[-1] == 2
@test_throws BoundsError memcopy!(a, -4, bo)
@test_throws BoundsError memcopy!(a, -1, bo)
fill!(a, -1)
memcopy!(a, -3, b, 2)
@test a[-3] == 2
@test a[-2] == a[-1] == -1
@test_throws BoundsError memcopy!(a, -3, b, 1, 4)
