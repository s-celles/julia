...
function run_map_equivalence_tests(mapf)
    ...
    testmap_equivalence(mapf, x->x ? false : true, BitArray(10,10))
    testmap_equivalence(mapf, x->"foobar", BitArray(10,10))
    testmap_equivalence(mapf, (x,y,z)->string(x,y,z), BitArray(10), ones(10), "1234567890")
end
